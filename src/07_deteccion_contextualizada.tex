...
En la sección \ref{sec:dataset_previous} hemos descripto el dataset de \citet{pavlopoulos2020toxicity}. En ese trabajo obtuvieron dos datasets de entrenamiento, uno etiquetado viendo el contexto y  otro sin verlo. El dataset de test sí fue etiquetado viendo el contextopropone la utilización de de RNNs y modelos basados en Transformers para contestar la pregunta de si el contexto puede ayudar a mejorar la detección de toxicidad (para mayores detalles, ver la sección \ref{sec:dataset_previous})
