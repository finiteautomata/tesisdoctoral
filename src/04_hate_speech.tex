...
\begin{table}
    ...
    \begin{tabular}{lll rrr rr}
        Modelo       & Salida         & Idioma     &  HS F1     & TR F1        &  AG F1        &   EMR       &  Macro F1       \\
        \mr{3}{beto} & multi         & \mr{3}{es}  &  0.741     &  \tbf{0.765} &  \tbf{0.688}  & 0.685       &     \tbf{0.731} \\
                     & jerárquico    &             &  0.735     &  0.758       &  0.674        & \tbf{0.703} &     0.722       \\
                     & combinatoria  &             &  \tbf{742} &  0.763       &  0.668        & 0.698       &     0.724       \\
    \end{tabular}
