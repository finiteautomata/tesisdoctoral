...
Con el advenimiento de los modelos basados en transformers, otros tipos de tokenización fueron propuestos que permiten reducir las palabras OOV.

En el caso de modelos basados en transformers, \citet{bertweet} plantearon dos formas de normalización del texto...
