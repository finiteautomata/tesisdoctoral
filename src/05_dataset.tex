...
\input{src/05_coleccion.tex}
\input{src/05_selection.tex}
...
\subsubsection{Modelo de etiquetado jerárquico y contextualizado}
...
\subsubsection{Perfil de etiquetadores}
