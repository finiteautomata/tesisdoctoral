...
Pocos trabajos incorporan algún tipo de contexto a los comentarios del usuario para estas tareas. \citet{gao-huang-2017-detecting} analiza el impacto de agregar contexto a un conjunto de datos de comentarios de los comentarios de Fox News. Sin embargo, los resultados de este estudio son frágiles debido a unas razones: primero, el conjunto de datos es bastante pequeño (10 hilos de Fox News, alrededor de 1.6k instancias) y su proceso de anotación lo realiza principalmente un anotador. Además, algunos de los resultados están sujetos a discusión, como la incorporación del nombre del usuario como característica predictiva.
...
Pocos trabajo han explorado la utilización de contexto para la detección de lenguaje de odio, o algunas otras tareas similares como la detección de lenguaje ofensivo. Uno de los primeros en utilizar el contexto para esta tarea es \citet{gao2018detecting}. En ese trabajo, fueron anotados 1528 comentarios provenientes de 10 hilos de Fox News. Usando las
