...
Como mencionamos en la Sección \ref{sec:dataset_previous}, no se ha dado demasiada atención en la literatura a la utilización de información contextual en la detección de discurso de odio y otros fenómenos similares. Pasamos ahora a describir los algoritmos de detección utilizados sobre los conjuntos de datos descriptos en dicha sección.
...
\begin{itemize}
    \item Contexto muy pequeño: sólo se considera el título de la discusión de Wikipedia Talk Pages y adicionalmente el comentario previo
    \item El hilo completo de los comentarios es ignorado
    \item Los comentarios fueron muestreados aleatoriamente
\end{itemize}
